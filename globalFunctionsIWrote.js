export function *sFunction(self, objectLocation, objectOnTray, objectHomeX, objectHomeY) {
...
self.stage.vars.baristalocation - self.stage.vars[objectLocation] > -30){
    ...
    if (
        ...
        self.costume.name === "FullTeaCup"
    ) {
        yield* self.score(self.stage.vars.teacupx);
    }
    return;
    }
}
